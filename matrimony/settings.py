...
# See https://docs.djangoproject.com/en/4.1/howto/deploy    `ment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = "django-insecure-hb0#zfjsnjx^ogz_xi@a7pgioqnc_l!3!^7yqqp3el779(_!09"
...
#add path to static files for every app
